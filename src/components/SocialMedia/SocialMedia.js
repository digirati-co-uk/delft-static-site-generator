...
export const SocialMedia = ({ socialConfig, tags }) => <div className="socialMedia">
           <FacebookShareButton url={socialConfig.config.url} className="button is-outlined is-rounded facebook" title={socialConfig.config.title}>
             <FacebookIcon size={32} round={true} />
           </FacebookShareButton>
           <TwitterShareButton className="button is-outlined is-rounded twitter" url={socialConfig.config.url} title={socialConfig.config.title} via={socialConfig.twitterHandle
               .split('@')
               .join('')} hashtags={tags}>
